export const TRY_ON_LAB_PROVIDER = Symbol("TRY_ON_LAB_PROVIDER");
...
export const TRY_ON_LAB_POLL_INTERVAL_MS = 2_000;
export const TRY_ON_LAB_PROVIDER_TIMEOUT_MS = 90_000;
