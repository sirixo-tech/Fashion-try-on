...
export const KIOSK_CAPTURE_DEFAULT_MAX_IMAGE_BYTES = 10 * 1024 * 1024;
export const KIOSK_PRESENTATION_DEFAULT_MAX_IMAGE_BYTES = 12 * 1024 * 1024;
export const KIOSK_PRESENTATION_DEFAULT_MAX_VIDEO_BYTES = 80 * 1024 * 1024;
export const KIOSK_PRESENTATION_MAX_VIDEO_DURATION_SECONDS = 60;
export const KIOSK_PRESENTATION_MAX_VIDEO_SLOTS = 5;
export const KIOSK_PRESENTATION_MAX_WALLPAPER_SLOTS = 5;
export const PLATFORM_IMAGE_UPLOAD_HARD_MAX_BYTES = 50 * 1024 * 1024;
export const PLATFORM_VIDEO_UPLOAD_HARD_MAX_BYTES = 150 * 1024 * 1024;
...
export const KIOSK_TRY_ON_SHARE_TTL_SECONDS = 5 * 60;
