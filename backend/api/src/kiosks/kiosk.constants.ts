...
export const KIOSK_ERROR_CODES = {
  ...
  tryOnShareInvalid: "KIOSK_TRY_ON_SHARE_INVALID",
  tryOnShareExpired: "KIOSK_TRY_ON_SHARE_EXPIRED",
  tryOnShareNoLooks: "KIOSK_TRY_ON_SHARE_NO_LOOKS",
...
export const KIOSK_TRY_ON_SHARE_TTL_SECONDS = 30 * 60;
